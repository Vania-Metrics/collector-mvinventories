// colecteur-mvinventories — produces a VaniaMetrics-<Name>-<v>.jar in build/libs/
//
...
// The version is the API's: read from the included core's Version.java, never
// copied by hand.
...
// identifies modules by their plugin name. One source, the one Bukkit displays.
